...
# THIS SCRIPT IS DESIGNED TO RUN EACH TEAM ONCE USING ONLY FUEL RODS. 

address = Web3.toChecksumAddress("")
key = ""
# TOTAL NUMBER OF TEAMS THAT YOU HAVE
NUM_TEAMS = 2
# IF YOU DONT WANT TO USE A FUEL ROD ON A TEAM, SET THE NUMBER BELOW, IF NOT, LEAVE AS -1
SKIP_TEAM = -1
